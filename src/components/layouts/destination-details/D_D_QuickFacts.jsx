...
const D_D_QuickFacts = ({ country }) => {
  ...
  return (
    <section className="py-10 md:py-16 lg:py-20 bg-tertiary">
      <Container>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6">
          ...
          {/* 1 */}
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6">
            <div className="group rounded-2xl border text-center md:text-left border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <div className="mb-4 inline-flex rounded-xl bg-orange-50 p-3 text-primary transition-transform duration-300 group-hover:scale-110">
                <FiDollarSign size={22} className="group-hover:rotate-12 transition-transform duration-300" />
              </div>
            ...
            <div className="group rounded-2xl border text-center md:text-left border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <div className="mb-4 inline-flex rounded-xl bg-orange-50 p-3 text-primary transition-transform duration-300 group-hover:scale-110">
                <FiGlobe size={22} className="group-hover:rotate-12 transition-transform duration-300" />
              </div>
              <p className="font-jost text-base font-semibold uppercase tracking-wider text-secondary/60">
                Language
              </p>
            ...
            <div className="group rounded-2xl border text-center md:text-left border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <div className="mb-4 inline-flex rounded-xl bg-orange-50 p-3 text-primary transition-transform duration-300 group-hover:scale-110">
                <FiMapPin size={22} className="group-hover:rotate-12 transition-transform duration-300" />
              </div>
              <p className="font-jost text-base font-semibold uppercase tracking-wider text-secondary/60">
                Capital
              </p>
            ...
            <div className="group rounded-2xl border text-center md:text-left border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              <div className="mb-4 inline-flex rounded-xl bg-orange-50 p-3 text-primary transition-transform duration-300 group-hover:scale-110">
                <FiUsers size={22} className="group-hover:rotate-12 transition-transform duration-300" />
              </div>
              <p className="font-jost text-base font-semibold uppercase tracking-wider text-secondary/60">
                Total Universities
              </p>
          ...
          <div className="group rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl lg:col-span-1">
            <div className="mb-4 mx-auto w-12 rounded-xl bg-orange-50 p-3 text-primary">
              <FiBookOpen
                size={22}
                className="group-hover:rotate-12 transition-transform duration-300 mx-auto"
              />
            </div>
            <p className="font-jost text-base font-semibold text-center uppercase tracking-wider text-secondary/60">
              Study Levels
            </p>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6">
          <div className="group rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl lg:col-span-1">
            <div className="mb-4 mx-auto w-12 rounded-xl bg-orange-50 p-3 text-primary">
              <FiCalendar size={22} className="group-hover:rotate-12 transition-transform duration-300 mx-auto"/>
            </div>
            <p className="font-jost text-center text-base font-semibold uppercase tracking-wider text-secondary/60">
              Available Intakes
            </p>
          ...
          <div className="group rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl lg:col-span-1">
            <div className="flex flex-col gap-4">
              <div className="">
                <div className="mb-4 mx-auto w-12 rounded-xl bg-orange-50 p-3 text-primary">
                  <FiLayers size={22} className="group-hover:rotate-12 transition-transform duration-300 mx-auto"/>
                </div>
                <div>
                  <p className="font-jost text-center text-base font-semibold uppercase tracking-wider text-secondary/60">
